...
resource "aws_security_group" "microservices-demo-staging-k8s" {
  ...
  tags = {
    yor_trace = "785d8ea9-be9f-4ab4-85ff-9498e521d4ab"
  }
}
...
resource "aws_instance" "k8s-node" {
  ...
  tags = {
    yor_trace = "7e4ee060-4174-4850-bfa7-fe84262ac903"
  }
}
...
resource "aws_instance" "k8s-master" {
  ...
  tags = {
    yor_trace = "10325a00-6a65-4e50-b058-a5d7fde65dcb"
  }
}
...
resource "aws_elb" "microservices-demo-staging-k8s" {
  ...
  tags = {
    yor_trace = "bdbad236-7a51-4e97-b96e-992fa067596e"
  }
}
